...
public:
  // stanje cvora predstavlja oznaku dodeljjenu cvoru pritiskom na tastere 1,2
  // ili 3 koristi se za utvrdjivanje smera grane prilikom vezivanje cvorova i
  // isto tako za brisanje odgovarajuce grane tj veze izmedju cvorva grana ide o
...
protected:
  void keyPressEvent(QKeyEvent *event)
      override; // stanje cvora se menja pritiskom da tastere 1,2 i 3
