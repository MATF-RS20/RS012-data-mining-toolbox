...
PerceptronParametersDialog::PerceptronParametersDialog(PerceptronNode* cvor, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::PerceptronParametersDialog),
    prcN(cvor)
{
    ui->setupUi(this);
}

PerceptronParametersDialog::~PerceptronParametersDialog()
{
    delete ui;
}
