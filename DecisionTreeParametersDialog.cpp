...
DecisionTreeParametersDialog::DecisionTreeParametersDialog(
    DecisionTreeNode *cvor, QWidget *parent)
    : QDialog(parent), ui(new Ui::DecisionTreeParametersDialog), dtN(cvor) {
  ui->setupUi(this);
}

DecisionTreeParametersDialog::~DecisionTreeParametersDialog() { delete ui; }
