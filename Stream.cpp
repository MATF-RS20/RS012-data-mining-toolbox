...
// TODO: Kopiranje Stream-a ne radi, zbog pokazivaca u mapi. Naci novi nacin za
// cuvanje strima ili drugacije implementirati kopiranje.
...
void Stream::add(Node *node) { mapOfNodes[node] = nullptr; }
...
// TODO: change disconnect function so it disconnects node 2 from all nodes it
// has connections to
...
std::map<Node *, Node *> Stream::MapOfNodes() const { return mapOfNodes; }
