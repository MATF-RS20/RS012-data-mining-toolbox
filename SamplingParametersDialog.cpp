...
SamplingParametersDialog::SamplingParametersDialog(SamplingNode *cvor,
                                                   QWidget *parent)
    : QDialog(parent), ui(new Ui::SamplingParametersDialog), smplN(cvor) {
  ui->setupUi(this);
}

SamplingParametersDialog::~SamplingParametersDialog() { delete ui; }
