...
FilterParametersDialog::FilterParametersDialog(FilterNode* cvor, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::FilterParametersDialog),
    filN(cvor)
{
    ui->setupUi(this);
}

FilterParametersDialog::~FilterParametersDialog()
{
    delete ui;
}
...
void FilterParametersDialog::on_IzbacivanjeKolone_clicked()
{
    ...
    if(selektovani.empty()){
        QMessageBox::information(this, "Graska!" , "Obaderite kolonu za izbacivanje iz prikazane liste");
        return;
    }
