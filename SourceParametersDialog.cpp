...
SourceParametersDialog::SourceParametersDialog(SourceNode *cvor,
                                               QWidget *parent)
    : QDialog(parent), ui(new Ui::SourceParametersDialog), UlazniCvor(cvor) {
  ui->setupUi(this);
}

SourceParametersDialog::~SourceParametersDialog() { delete ui; }

void SourceParametersDialog::on_OdaberiFajl_clicked() {
  QString fileName = QFileDialog::getOpenFileName(
      this, tr("Odaberite CSV Fajl"), "/home", "CSV Files (*.csv)");
