...
size_t ClassificationNode::NumClasses() const { return numClasses; }

std::string ClassificationNode::GetPrecision() const { return precision; }
...
void ClassificationNode::Precision(arma::Row<size_t> values,
...
void ClassificationNode::ConfusionMatrix(arma::Row<size_t> values,
                                         arma::Row<size_t> predictions) {
