...
void DecisionTreeNode::run() {
    ...
    if (!dt.IsPartitioned()){
        ...
        //Split data and predictions into testData, testTarget and trainData, trainTarget
        ...
        //Calculate precision and confusion matrix from testTarget and above calculated predictions
